...
def get_all_run_params():
    ...
    base_params = list(product(std_dev_scales, bias_height_fractions, 
                            perturbations, optimizers, min_height_scales, max_height_scales, min_cov_scales, max_cov_scales))
...
def single_run(args):
    run_id, std_scale, height_frac, perturb, opt, min_height_scale, max_height_scale, min_cov_scale, max_cov_scale = args
