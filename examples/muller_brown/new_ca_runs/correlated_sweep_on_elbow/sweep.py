...
def get_all_run_params():
    ...
    base_params = list(product(std_dev_scales, bias_height_fractions, 
                            perturbations, optimizers, adaptive_height_scales, adaptive_cov_scales, pert_type))
...
def single_run(args):
    run_id, std_scale, height_frac, perturb, opt, adaptive_height_scale, adaptive_cov_scale, pert_type = args
    ...
    pert = "fixed" if pert_type == 0 else "adaptive"
