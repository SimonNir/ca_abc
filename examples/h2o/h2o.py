...
atoms.calc = pyscf_calculator

# --- 4. Wrap the ASE system in the CanonicalASEPES ---
print("Wrapping the system in CanonicalASEPES...")
pes = CanonicalASEPotential(atoms)

pos = cartesian_to_internal(align_to_canonical(atoms.positions.copy()))
...
analyzer.plot_summary(save_plots=True, plot_type="neither", filename="h2o_summary.png")
analyzer.plot_diagnostics(save_plots=True, plot_type="neither", filename="h2o_diagnostics.png")
