            ...
            for perturb in perturbations:
                ...
                for opt in [0,1]:
                    ...
                    for seed in seeds:
                        ...
                        print(f"Completed run {run_id} | seed {seed} | height {bias_height:.4f} | cov {bias_cov:.5f} | perturb {perturb:.5f} | optimizer {optimizer}")

    df = pd.DataFrame(results)
    df.to_csv("muller_brown_sweep.csv", index=False)
